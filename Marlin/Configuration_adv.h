 ...
 */
#define E0_AUTO_FAN_PIN FAN_EXT1_PIN
#define E1_AUTO_FAN_PIN FAN_EXT2_PIN
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN LIGHT_PIN            // Override the default pin if needed
  #define INVERT_CASE_LIGHT false             // Set true if Case Light is ON when pin is LOW
  #define CASE_LIGHT_DEFAULT_ON true          // Set default power-up state on
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 255   // Set default power-up brightness (0-255, requires PWM pin) SJH - was 105, but now not a PWM pin
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 2  // Unload filament feedrate in mm/s - filament unloading can be fast // SJH - was 10
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 0   // Unload filament length from hotend in mm // SJH- was 100
 ...
 */
/*
// SJH I2C LED write routine
 void writeLEDDigits(int value) {
  char wr_address = 0x70 ;
  char rd_address = 0x71 ;
  char ctrl_init = 0x0f ; // Turn all LEDs on for segment test
  char ctrl_normal = 0x07 ;
  char instruction = 0x00 ; // Start with control byte, then auto-increment
  // Test all
  i2c_send(wr_address) ;
  i2c_send(instruction) ;
  i2c_send(ctrl_init) ;
  i2c_send(0xff) ; // Digit 1 segments
  i2c_send(0xff) ; // Digit 2 segments
  i2c_send(0xff) ; // Digit 3 segments
  i2c_send(0xff) ; // Digit 4 segments
 }
 */
