...
#define STRING_CONFIG_H_AUTHOR "(Harry, migrated config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Harry's i3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 10, 25} // Folgertech was {250, 250, 2, 22}
...
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 5, 1000 } // Folgertech was {1000, 1000, 5, 1000}
...
//#define Z_MIN_PROBE_PIN // SJH: Pin set in pins_RAMPS.h
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 100   // (ms) Enable and increase if needed - was 375
#endif
...
//  #define MIN_SOFTWARE_ENDSTOP_Z // Disable to allow manual fine control of Z-probe
#endif
 ...
 */
  ...
  #define LEFT_PROBE_BED_POSITION 5 + X_PROBE_OFFSET_FROM_EXTRUDER // was 15
  #define RIGHT_PROBE_BED_POSITION X_BED_SIZE - 5  // X_PROBE_OFFSET_FROM_EXTRUDER - 5 // was 170 
  #define FRONT_PROBE_BED_POSITION 5 + Y_PROBE_OFFSET_FROM_EXTRUDER // was 20
  #define BACK_PROBE_BED_POSITION Y_BED_SIZE - Y_PROBE_OFFSET_FROM_EXTRUDER - 5 // was 170
...
// Does selecting stop on the LCD disable the heaters?
// #define LCD_STOP_DISABLES_HEATERS
