...
// LCD Menu Messages
	...
	#define MSG_PREHEAT_PLA_SETTINGS "Preheat PLA (E1) Conf"
	#define MSG_PREHEAT_ABS "Preheat ABS (E0)"
	#define MSG_PREHEAT_ABS_SETTINGS "Preheat ABS (E0) Conf"
	#define MSG_COOLDOWN_ALL "Cooldown all"
  #define MSG_COOLDOWN_EXTRUDERS "Cool extruders"
  ...
  #define MSG_LIGHTS "Light control"
  #define MSG_LIGHTS_BRIGHTNESS "Brightness"
  #define MSG_LIGHTS_UPDATE "Update brightness"
